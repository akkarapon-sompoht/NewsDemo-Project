...
import 'package:NewsDemo01/drawer_menu.dart';
...
class _NewsPageState extends State<NewsPage> {
  ...
  Future<String> _GetNewsAPI() async {
    var response = await Http.get('http://newsapi.org/v2/top-headlines?country=th&from=2020-12-14&sortBy=publishedAt&apiKey=7428f03ff2ce4c7b97403342a99bb69c');
